...
output_150in1 ="windprofil 150in1.png"
...
plt.figure(5, figsize=(10,5), dpi=300)
plt.plot(u_ru[10]["I"],z,'--',color='blue',label="Land,I")
plt.plot(u_ru[10]["III/2"],z,'--',color='orange',label="Land,III/2")
plt.plot(u_ci[10]["I"],z,color='blue',label="Stadt,I")
plt.plot(u_ci[10]["III/2"],z,color='orange',label="Stadt,III/2")
plt.xlabel("Windgeschwindigkeit in m/s")
plt.ylabel("Höhe über Grund in m")
plt.legend()
plt.grid()
plt.savefig(output_path/output_10in1)

plt.figure(6, figsize=(10,5), dpi=300)
plt.plot(u_ru[150]["I"],z,'--',color='blue',label="Land,I")
plt.plot(u_ru[150]["III/2"],z,'--',color='orange',label="Land,III/2")
plt.plot(u_ci[150]["I"],z,color='blue',label="Stadt,I")
plt.plot(u_ci[150]["III/2"],z,color='orange',label="Stadt,III/2")
plt.xlabel("Windgeschwindigkeit in m/s")
plt.ylabel("Höhe über Grund in m")
plt.legend()
plt.grid()
plt.savefig(output_path/output_150in1)